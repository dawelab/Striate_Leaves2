...
kpAddLabels(kp, labels="Ab10-Df(K)", data.panel = 1,  r0=0, r1=0.1)
kpBars(kp, chr="Ab10", x0=M_xs, x1=M_xe, y0=M_yb, y1=M_yt, data.panel = 1, r0=0.20, r1=0.8)
kpAddLabels(kp, labels="Ab10-Df(M)", data.panel = 1,  r0=0.2, r1=0.3)
kpBars(kp, chr="Ab10", x0=L_xs, x1=L_xe, y0=L_yb, y1=L_yt, data.panel = 1, r0=0.45, r1=1)
kpAddLabels(kp, labels="Ab10-Df(L)", data.panel = 1,  r0=0.45, r1=0.55)
...
kpArrows(kp, chr="Ab10", x0=167426118, x1=167426118, y0=-.05, y1=0, col="red", lwd=4)
kpArrows(kp, chr="Ab10", x0=177845876, x1=177845876, y0=0.4, y1=0.45, col="red", lwd=4)
kpArrows(kp, chr="Ab10", x0=172190001, x1=172190001, y0=0.15, y1=0.2, col="red", lwd=4)
dev.off()
