...
#my 490 gene is at 151806944 in B73 
#gene 500 is at 151809681
#gene 510 is at 151941902
#gene 520 is at 151944890
#gene 530 is at 151946938
#gene 540 is at 151948302
#I removed the gene (510 and 520) that have an inverted orthologue so that I only highlight the orthologues that could contain sr2
...
###### In this section I want to pull out all the Gene Names for Ab10 and B73 with unexpected orthologues 
...
kpArrows(kp, chr="N10", x0=150834905, x1=150834905, y0=0.15, y1=-0.1, col="black", lwd=2)
kpArrows(kp, chr="Ab10", x0=161788577, x1=161788577, y0=-0.4, y1=-0.22, col="black", lwd=2)
kpArrows(kp, chr="N10", x0=146758676, x1=146758676, y0=0.15, y1=-0.1, col="black", lwd=2)
kpArrows(kp, chr="Ab10", x0=167105020, x1=167105020, y0=-0.4, y1=-0.1, col="black", lwd=2)
dev.off()
